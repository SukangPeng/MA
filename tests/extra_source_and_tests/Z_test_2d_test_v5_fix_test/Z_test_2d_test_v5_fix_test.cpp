...
std::vector<Vecd> createFixed1Shape()
{
    ...
    fixed_shape1.push_back(Vecd(0.2, 1.5));
    fixed_shape1.push_back(Vecd(-0.2, 1.5));
    fixed_shape1.push_back(Vecd(-0.2, 1));
    fixed_shape1.push_back(Vecd(0.2, 1));
    fixed_shape1.push_back(Vecd(0.2, 1.5));
...
std::vector<Vecd> createFixed2Shape()
{
    ...
    fixed_shape2.push_back(Vecd(0.15, 1.5));
    fixed_shape2.push_back(Vecd(0.15, 5));
    fixed_shape2.push_back(Vecd(-0.15, 5));
    fixed_shape2.push_back(Vecd(-0.15, 1.5));
    fixed_shape2.push_back(Vecd(0.15, 1.5));
...
class WaterBlock : public MultiPolygonShape
{
  public:
    explicit WaterBlock(const std::string &import_model_name) : MultiPolygonShape(import_model_name)
    {
        ...
        multi_polygon_.addAPolygon(createFixed1Shape(), ShapeBooleanOps::sub);
        multi_polygon_.addAPolygon(createFixed2Shape(), ShapeBooleanOps::sub);
    }
};
...
int main(int ac, char *av[])
{
    ...
    // Constrain
    BodyRegionByParticle fix_base(vessel_wall, makeShared<MultiPolygonShape>(createFixedBaseShape()));
    SimpleDynamics<FixBodyPartConstraint> constraint_fix_base(fix_base);
    //----------------------------------------------------------------------
