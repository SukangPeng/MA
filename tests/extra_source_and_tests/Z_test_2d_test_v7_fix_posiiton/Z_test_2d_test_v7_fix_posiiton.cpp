...
std::vector<Vecd> createFixed1Shape()
{
    // geometry
    std::vector<Vecd> fixed_shape1;
    fixed_shape1.push_back(Vecd(-0.3, 0.0));
    fixed_shape1.push_back(Vecd(-0.5, 0.0));
    fixed_shape1.push_back(Vecd(-0.5, 0.5));
    fixed_shape1.push_back(Vecd(-0.3, 0.5));
    fixed_shape1.push_back(Vecd(-0.3, 0.0));

    return fixed_shape1;
}
std::vector<Vecd> createFixed2Shape()
{
    // geometry
    std::vector<Vecd> fixed_shape2;
    fixed_shape2.push_back(Vecd(-3.531088913, 6.75));
    fixed_shape2.push_back(Vecd(-3.481088913, 6.83660254));
    fixed_shape2.push_back(Vecd(-3.431088913, 6.923205081));
    fixed_shape2.push_back(Vecd(-3.214582562, 6.798205081));
    fixed_shape2.push_back(Vecd(-2.998076211, 6.673205081));
    fixed_shape2.push_back(Vecd(-3.048076211, 6.58660254));
    fixed_shape2.push_back(Vecd(-3.098076211, 6.5));
    fixed_shape2.push_back(Vecd(-3.314582562, 6.625));
    fixed_shape2.push_back(Vecd(-3.531088913, 6.75));

    return fixed_shape2;
}
std::vector<Vecd> createFixed3Shape()
{
    // geometry
    std::vector<Vecd> fixed_shape3;
    fixed_shape3.push_back(Vecd(0.3, 0.0));
    fixed_shape3.push_back(Vecd(0.3, 0.5));
    fixed_shape3.push_back(Vecd(0.5, 0.5));
    fixed_shape3.push_back(Vecd(0.5, 0.0));
    fixed_shape3.push_back(Vecd(0.3, 0.0));

    return fixed_shape3;
}
std::vector<Vecd> createFixed4Shape()
{
    // geometry
    std::vector<Vecd> fixed_shape4;
    fixed_shape4.push_back(Vecd(3.531088913, 6.75));
    fixed_shape4.push_back(Vecd(3.314582562, 6.625));
    fixed_shape4.push_back(Vecd(3.098076211, 6.5));
    fixed_shape4.push_back(Vecd(3.048076211, 6.58660254));
    fixed_shape4.push_back(Vecd(2.998076211, 6.673205081));
    fixed_shape4.push_back(Vecd(3.214582562, 6.798205081));
    fixed_shape4.push_back(Vecd(3.431088913, 6.923205081));
    fixed_shape4.push_back(Vecd(3.481088913, 6.83660254));
    fixed_shape4.push_back(Vecd(3.531088913, 6.75));

    return fixed_shape4;
}
std::vector<Vecd> createFixed5Shape()
{
    // geometry
    std::vector<Vecd> fixed_shape5;
    fixed_shape5.push_back(Vecd(-2.698076211, 7.192820323));
    fixed_shape5.push_back(Vecd(-2.914582562, 7.317820323));
    fixed_shape5.push_back(Vecd(-3.131088913, 7.442820323));
    fixed_shape5.push_back(Vecd(-3.081088913, 7.529422863));
    fixed_shape5.push_back(Vecd(-3.031088913, 7.616025404));
    fixed_shape5.push_back(Vecd(-2.814582562, 7.491025404));
    fixed_shape5.push_back(Vecd(-2.598076211, 7.366025404));
    fixed_shape5.push_back(Vecd(-2.648076211, 7.279422863));
    fixed_shape5.push_back(Vecd(-2.698076211, 7.192820323));

    return fixed_shape5;
}
std::vector<Vecd> createFixed6Shape()
{
    // geometry
    std::vector<Vecd> fixed_shape6;
    fixed_shape6.push_back(Vecd(2.698076211, 7.192820323));
    fixed_shape6.push_back(Vecd(2.648076211, 7.279422863));
    fixed_shape6.push_back(Vecd(2.598076211, 7.366025404));
    fixed_shape6.push_back(Vecd(2.814582562, 7.491025404));
    fixed_shape6.push_back(Vecd(3.031088913, 7.616025404));
    fixed_shape6.push_back(Vecd(3.081088913, 7.529422863));
    fixed_shape6.push_back(Vecd(3.131088913, 7.442820323));
    fixed_shape6.push_back(Vecd(2.914582562, 7.317820323));
    fixed_shape6.push_back(Vecd(2.698076211, 7.192820323));
...
class Fixed : public MultiPolygonShape
{
  public:
    ...
    {
        multi_polygon_.addAPolygon(createFixed1Shape(), ShapeBooleanOps::add);
        multi_polygon_.addAPolygon(createFixed2Shape(), ShapeBooleanOps::add);
        multi_polygon_.addAPolygon(createFixed3Shape(), ShapeBooleanOps::add);
        multi_polygon_.addAPolygon(createFixed4Shape(), ShapeBooleanOps::add);
        multi_polygon_.addAPolygon(createFixed5Shape(), ShapeBooleanOps::add);

        multi_polygon_.addAPolygon(createFixed6Shape(), ShapeBooleanOps::add);


    }
};

/** create the fixed base as constrain shape. */
MultiPolygon createFixedBaseShape()
{
    MultiPolygon multi_polygon;

    multi_polygon.addAPolygon(createFixed1Shape(), ShapeBooleanOps::add);
    multi_polygon.addAPolygon(createFixed2Shape(), ShapeBooleanOps::add);
    multi_polygon.addAPolygon(createFixed3Shape(), ShapeBooleanOps::add);
    multi_polygon.addAPolygon(createFixed4Shape(), ShapeBooleanOps::add);    
    multi_polygon.addAPolygon(createFixed5Shape(), ShapeBooleanOps::add);    
    multi_polygon.addAPolygon(createFixed6Shape(), ShapeBooleanOps::add);    
...
int main(int ac, char *av[])
{
    ...
    InnerRelation vessel_wall_inner(vessel_wall);
    ContactRelation water_block_contact(water_block, {&vessel_wall});
