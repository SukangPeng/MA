...
MultiPolygon createFixedBaseShape()
{
    ...
    multi_polygon.addAPolygonFromFile(fixed_left_bottom, ShapeBooleanOps::add);
    multi_polygon.addAPolygonFromFile(fixed_right_bottom, ShapeBooleanOps::add);
    multi_polygon.addAPolygonFromFile(fixed_left_top_down, ShapeBooleanOps::add);
    multi_polygon.addAPolygonFromFile(fixed_right_top_down, ShapeBooleanOps::add);
    multi_polygon.addAPolygonFromFile(fixed_left_top_up, ShapeBooleanOps::add);
    multi_polygon.addAPolygonFromFile(fixed_right_top_up, ShapeBooleanOps::add);
